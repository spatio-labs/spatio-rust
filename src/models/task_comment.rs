...
pub struct TaskComment {
    ...
    #[serde(rename = "author")]
    pub author: Box<models::TaskCommentAuthor>,
}

impl TaskComment {
    pub fn new(id: String, task_id: String, content: String, created_at: chrono::DateTime<chrono::FixedOffset>, updated_at: chrono::DateTime<chrono::FixedOffset>, author: models::TaskCommentAuthor) -> TaskComment {
        TaskComment {
            id,
            task_id,
            content,
