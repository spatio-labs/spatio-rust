...
pub struct CalendarProvidersInfo {
    #[serde(rename = "providers")]
    pub providers: Vec<models::CalendarProviderInfo>,
}

impl CalendarProvidersInfo {
    /// Registered calendar providers. Returned regardless of whether the caller has connected any. 
    pub fn new(providers: Vec<models::CalendarProviderInfo>) -> CalendarProvidersInfo {
