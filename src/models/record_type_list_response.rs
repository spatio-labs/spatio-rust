...
pub struct RecordTypeListResponse {
    #[serde(rename = "record_types")]
    pub record_types: Vec<models::RecordType>,
}

impl RecordTypeListResponse {
    pub fn new(record_types: Vec<models::RecordType>) -> RecordTypeListResponse {
