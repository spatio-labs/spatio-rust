...
pub struct CreateCalendarEvent201Response {
    #[serde(rename = "success")]
    pub success: bool,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SpatioEvent>>,
...
impl CreateCalendarEvent201Response {
    pub fn new(success: bool) -> CreateCalendarEvent201Response {
