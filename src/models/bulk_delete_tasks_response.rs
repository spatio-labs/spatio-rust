...
pub struct BulkDeleteTasksResponse {
    ...
    #[serde(rename = "failed")]
    pub failed: Vec<models::BulkDeleteTasksResponseFailedInner>,
}

impl BulkDeleteTasksResponse {
    ...
    pub fn new(success: bool, affected_count: i32, task_ids: Vec<String>, failed: Vec<models::BulkDeleteTasksResponseFailedInner>) -> BulkDeleteTasksResponse {
