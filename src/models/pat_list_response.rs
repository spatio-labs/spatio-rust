...
pub struct PatListResponse {
    #[serde(rename = "tokens")]
    pub tokens: Vec<models::PersonalAccessToken>,
    #[serde(rename = "availableScopes", skip_serializing_if = "Option::is_none")]
    pub available_scopes: Option<Vec<String>>,
}

impl PatListResponse {
    pub fn new(tokens: Vec<models::PersonalAccessToken>) -> PatListResponse {
        PatListResponse {
            tokens,
