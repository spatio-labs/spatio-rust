...
pub struct UpdateParticipantStateRequest {
    #[serde(rename = "audioEnabled", skip_serializing_if = "Option::is_none")]
    pub audio_enabled: Option<bool>,
    #[serde(rename = "videoEnabled", skip_serializing_if = "Option::is_none")]
    pub video_enabled: Option<bool>,
    #[serde(rename = "screenShareEnabled", skip_serializing_if = "Option::is_none")]
    pub screen_share_enabled: Option<bool>,
}

impl UpdateParticipantStateRequest {
    /// Toggle audio/video/screen-share state.
    pub fn new() -> UpdateParticipantStateRequest {
