...
pub struct CallRecordingListResponse {
    #[serde(rename = "recordings", deserialize_with = "Option::deserialize")]
    pub recordings: Option<Vec<models::CallRecording>>,
}

impl CallRecordingListResponse {
    pub fn new(recordings: Option<Vec<models::CallRecording>>) -> CallRecordingListResponse {
