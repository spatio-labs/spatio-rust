...
pub struct AgentConversationListResponse {
    ...
    pub conversations: Vec<models::AgentConversation>,
    #[serde(rename = "total", skip_serializing_if = "Option::is_none")]
    pub total: Option<i32>,
}

impl AgentConversationListResponse {
    pub fn new(conversations: Vec<models::AgentConversation>) -> AgentConversationListResponse {
