...
pub struct WorkspaceInvitationListResponse {
    ...
    pub invitations: Vec<models::WorkspaceInvitation>,
}

impl WorkspaceInvitationListResponse {
    pub fn new(invitations: Vec<models::WorkspaceInvitation>) -> WorkspaceInvitationListResponse {
