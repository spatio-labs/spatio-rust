...
pub struct ConnectedAppsListResponse {
    #[serde(rename = "items")]
    pub items: Vec<models::ConnectedAppItem>,
}

impl ConnectedAppsListResponse {
    pub fn new(items: Vec<models::ConnectedAppItem>) -> ConnectedAppsListResponse {
