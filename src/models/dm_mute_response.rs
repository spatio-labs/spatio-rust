...
pub struct DmMuteResponse {
    #[serde(rename = "mutedUntil", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub muted_until: Option<Option<i64>>,
}

impl DmMuteResponse {
    pub fn new() -> DmMuteResponse {
        DmMuteResponse {
            muted_until: None,
        }
    }
