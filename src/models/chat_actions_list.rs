...
pub struct ChatActionsList {
    #[serde(rename = "actions")]
    pub actions: Vec<models::ChatActionDefinition>,
}

impl ChatActionsList {
    pub fn new(actions: Vec<models::ChatActionDefinition>) -> ChatActionsList {
        ChatActionsList {
            actions,
        }
    }
