...
pub struct BulkDeleteEmailsResponse {
    #[serde(rename = "success")]
    pub success: bool,
    #[serde(rename = "deleted")]
    pub deleted: Vec<String>,
    #[serde(rename = "failed")]
    pub failed: Vec<models::BulkArchiveResponseFailedInner>,
}

impl BulkDeleteEmailsResponse {
    /// Partial-success envelope for `bulkDeleteEmails`.
    pub fn new(success: bool, deleted: Vec<String>, failed: Vec<models::BulkArchiveResponseFailedInner>) -> BulkDeleteEmailsResponse {
