...
pub struct TaskProvidersInfo {
    /// Registered provider ids (e.g. `native-tasks`, `linear`).
    #[serde(rename = "providers")]
    pub providers: Vec<String>,
    #[serde(rename = "platform")]
    pub platform: Box<models::TaskProvidersInfoPlatform>,
}

impl TaskProvidersInfo {
    /// Metadata about which task providers are connected and what the Tasks platform itself reports for its name + description. 
    pub fn new(providers: Vec<String>, platform: models::TaskProvidersInfoPlatform) -> TaskProvidersInfo {
        TaskProvidersInfo {
            providers,
