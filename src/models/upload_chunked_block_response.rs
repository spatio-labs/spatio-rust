...
pub struct UploadChunkedBlockResponse {
...
impl UploadChunkedBlockResponse {
    pub fn new(block_hash: String, uploaded: bool, blocks_remaining: i32, progress: f64) -> UploadChunkedBlockResponse {
