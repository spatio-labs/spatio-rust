...
pub struct BulkDeleteTasksResponseFailedInner {
    #[serde(rename = "taskId")]
    pub task_id: String,
    #[serde(rename = "error")]
    pub error: String,
...
impl BulkDeleteTasksResponseFailedInner {
    pub fn new(task_id: String, error: String) -> BulkDeleteTasksResponseFailedInner {
