...
pub struct CoreActionListResponse {
    #[serde(rename = "actions", deserialize_with = "Option::deserialize")]
    pub actions: Option<Vec<models::CoreAction>>,
    #[serde(rename = "total", skip_serializing_if = "Option::is_none")]
    pub total: Option<i32>,
}

impl CoreActionListResponse {
    pub fn new(actions: Option<Vec<models::CoreAction>>) -> CoreActionListResponse {
