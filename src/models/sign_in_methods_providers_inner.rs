...
pub struct SignInMethodsProvidersInner {
    ...
    pub linked_at: Option<chrono::DateTime<chrono::FixedOffset>>,
...
impl SignInMethodsProvidersInner {
    pub fn new(provider: String) -> SignInMethodsProvidersInner {
