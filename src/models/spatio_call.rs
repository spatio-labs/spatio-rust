...
pub struct SpatioCall {
    ...
    #[serde(rename = "hostUserId", skip_serializing_if = "Option::is_none")]
    ...
    pub participants: Option<Vec<std::collections::HashMap<String, serde_json::Value>>>,
...
impl SpatioCall {
    pub fn new(id: String) -> SpatioCall {
        SpatioCall {
            id,
            title: None,
            status: None,
