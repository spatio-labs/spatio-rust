...
pub struct AppFileListResponse {
    #[serde(rename = "files", deserialize_with = "Option::deserialize")]
    pub files: Option<Vec<std::collections::HashMap<String, serde_json::Value>>>,
}

impl AppFileListResponse {
    pub fn new(files: Option<Vec<std::collections::HashMap<String, serde_json::Value>>>) -> AppFileListResponse {
        AppFileListResponse {
            files,
        }
    }
