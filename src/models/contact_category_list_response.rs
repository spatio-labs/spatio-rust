...
pub struct ContactCategoryListResponse {
    #[serde(rename = "categories", deserialize_with = "Option::deserialize")]
    pub categories: Option<Vec<models::ContactCategory>>,
}

impl ContactCategoryListResponse {
    pub fn new(categories: Option<Vec<models::ContactCategory>>) -> ContactCategoryListResponse {
