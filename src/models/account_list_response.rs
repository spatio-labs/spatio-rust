...
pub struct AccountListResponse {
    #[serde(rename = "accounts_by_platform", skip_serializing_if = "Option::is_none")]
    pub accounts_by_platform: Option<std::collections::HashMap<String, serde_json::Value>>,
