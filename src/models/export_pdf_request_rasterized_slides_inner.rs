...
pub struct ExportPdfRequestRasterizedSlidesInner {
...
impl ExportPdfRequestRasterizedSlidesInner {
    pub fn new(slide_id: String, png: String) -> ExportPdfRequestRasterizedSlidesInner {
