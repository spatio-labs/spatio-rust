...
pub struct Attendee {
    ...
    #[serde(rename = "status")]
    pub status: models::AttendeeStatus,
    #[serde(rename = "role")]
    pub role: models::AttendeeRole,
    ...
    #[serde(rename = "additional_guests", skip_serializing_if = "Option::is_none")]
    pub additional_guests: Option<i32>,
}

impl Attendee {
    pub fn new(email: String, status: models::AttendeeStatus, role: models::AttendeeRole, optional: bool) -> Attendee {
        Attendee {
            email,
            name: None,
            status,
