...
pub struct ContactProviderListResponse {
    #[serde(rename = "providers")]
    pub providers: Vec<models::ContactProvider>,
}

impl ContactProviderListResponse {
    pub fn new(providers: Vec<models::ContactProvider>) -> ContactProviderListResponse {
