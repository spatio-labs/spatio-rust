...
pub struct OrganizationMemberListResponse {
    ...
    pub members: Vec<models::OrganizationMember>,
    #[serde(rename = "total")]
    pub total: i32,
}

impl OrganizationMemberListResponse {
    pub fn new(members: Vec<models::OrganizationMember>, total: i32) -> OrganizationMemberListResponse {
