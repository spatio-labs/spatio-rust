...
pub struct OrganizationInvitationListResponse {
    #[serde(rename = "invitations")]
    pub invitations: Vec<models::OrganizationInvitation>,
}

impl OrganizationInvitationListResponse {
    pub fn new(invitations: Vec<models::OrganizationInvitation>) -> OrganizationInvitationListResponse {
