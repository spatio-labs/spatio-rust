...
pub struct SlideElementList {
    #[serde(rename = "elements")]
    pub elements: Vec<models::SlideElement>,
    #[serde(rename = "total")]
    pub total: i32,
}

impl SlideElementList {
    pub fn new(elements: Vec<models::SlideElement>, total: i32) -> SlideElementList {
        SlideElementList {
            elements,
            total,
        }
