...
pub struct TaskCommentAuthor {
    ...
    #[serde(rename = "email")]
    pub email: String,
    #[serde(rename = "profilePhoto", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub profile_photo: Option<Option<String>>,
}

impl TaskCommentAuthor {
    pub fn new(id: String, name: String, email: String) -> TaskCommentAuthor {
        TaskCommentAuthor {
            id,
            name,
            email,
