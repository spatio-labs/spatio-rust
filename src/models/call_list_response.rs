...
pub struct CallListResponse {
    #[serde(rename = "calls", deserialize_with = "Option::deserialize")]
    pub calls: Option<Vec<models::SpatioCall>>,
    #[serde(rename = "total", skip_serializing_if = "Option::is_none")]
    pub total: Option<i32>,
}

impl CallListResponse {
    pub fn new(calls: Option<Vec<models::SpatioCall>>) -> CallListResponse {
        CallListResponse {
            calls,
            total: None,
        }
