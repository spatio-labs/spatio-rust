...
pub struct PresentationListEnvelope {
    #[serde(rename = "items")]
    pub items: Vec<models::Presentation>,
    #[serde(rename = "accounts")]
    pub accounts: Vec<models::AccountStatus>,
}

impl PresentationListEnvelope {
    pub fn new(items: Vec<models::Presentation>, accounts: Vec<models::AccountStatus>) -> PresentationListEnvelope {
