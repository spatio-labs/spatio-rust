...
pub struct EmailFolderListResponse {
    #[serde(rename = "folders", deserialize_with = "Option::deserialize")]
    pub folders: Option<Vec<models::EmailFolder>>,
}

impl EmailFolderListResponse {
    pub fn new(folders: Option<Vec<models::EmailFolder>>) -> EmailFolderListResponse {
