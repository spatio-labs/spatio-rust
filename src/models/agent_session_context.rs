...
pub struct AgentSessionContext {
    ...
    #[serde(rename = "currentOrganization", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub current_organization: Option<Option<std::collections::HashMap<String, serde_json::Value>>>,
    #[serde(rename = "currentWorkspace", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub current_workspace: Option<Option<std::collections::HashMap<String, serde_json::Value>>>,
    #[serde(rename = "connectedAccounts", skip_serializing_if = "Option::is_none")]
    pub connected_accounts: Option<Vec<std::collections::HashMap<String, serde_json::Value>>>,
}
